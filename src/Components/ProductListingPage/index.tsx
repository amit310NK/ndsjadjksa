    ...
    <div className="container mt-2 py-2 d-flex justify-content-between ">
      <div className="filters bg-white">
        ...
        <div className="box d-flex justify-content-center align-items-center">
          <div className="filter-container d-flex flex-column align-items-start ">
            ...
            {brands.map((item, pos) => {
              return (
                <div key={pos} className="d-flex justify-content-between my-1">
                  <input
                    type="checkbox"
                    name={item.name}
                    id={item.id}
                  ...
                  />
                  <label htmlFor={item.htmlFor} style={{ marginLeft: "10px" }}>
      ...
      <div className="listing-area">
        <div className="listing-header">
          <span style={{ color: "grey" }}>Home / Decoration / Artificial</span>
